            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">						
						...
						function modify_illust(){
							
							if(confirm("일러스트를 수정하시겠습니까?") == true)
								$('#modify_form').submit();
                        ...
                        function delete_illust(){
							if(confirm("일러스트를 삭제하시겠습니까?") == true){
								var post_no = <?php echo $post_no;?>;
				...
				<div class="container px-4 px-lg-5 my-5">
					<div class="row gx-4 gx-lg-5 div-height" >
							...
							<?php
									...
									$conn = connect_db();
									$query = 'SELECT i.post_title,
													i.brief_comment,
													i.contents_dir, 
													u.nick_name
													FROM illust_post i, _user u 
													WHERE i.post_no='.$post_no.' and u.id_no=i.user_no';	
							...
							<div class="col-md-6 center">
								...
								id="preview-image" src="<?php echo $contents_dir;?>" alt="..." />
							</div>
							<div class="col-md-6 descript-area">
								...
								<div style="border-width: 1px 0px 0px 0px; border-style: solid; text-align:right; padding-top:1rem;">
									...
									<form id='modify_form' action='modify_illust.php' method='POST'>
										<?php 
										
											if($cur_user == $nick_name){
												// 현재 세션 변수의 nick_name과 일러스트 업로더의 nick_name이 서로 같으면 수정/삭제 기능을 보여줌
												
												echo '<input type = "hidden" name="post_no" value="'.$post_no.'"/>'.
													'<input type = "button" class="btn btn-outline-dark mt-auto" value="게시글 수정" onclick="modify_illust()"/>
													<input type = "button" class="btn btn-outline-dark mt-auto" value="게시글 삭제" onclick="delete_illust()"/>';
											}
